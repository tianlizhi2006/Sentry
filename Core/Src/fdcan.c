...
/* USER CODE BEGIN 0 */
uint32_t check_fdcan1_RAM_Offset;    /* 计算fdcan1占用RAM的大小(需要减去fdcan2的MessageRAMOffset) (check_fdcan1_RAM_Offset = hfdcan1.msgRam.EndAddress - SRAMCAN_BASE)*/
uint32_t check_fdcan2_RAM_Offset;    /* 计算fdcan1和fdcan2占用RAM的大小(需要减去fdcan3的MessageRAMOffset) (check_fdcan2_RAM_Offset = hfdcan2.msgRam.EndAddress - SRAMCAN_BASE)*/
...
void MX_FDCAN2_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN2_Init 2 */
	...
	FDCAN2_RXFilter.FilterID1=0x0201; /* 3508 ID1 */
	FDCAN2_RXFilter.FilterID2=0x0204; /* 3508 ID4 */
...
void MX_FDCAN3_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN3_Init 2 */
	...
	FDCAN3_RXFilter.FilterID1=0x0001; /* 云台 IMU */
	FDCAN3_RXFilter.FilterID2=0x07FF; /* 标准 ID 全掩码 */
